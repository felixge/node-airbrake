...
Airbrake.prototype._registerProcessHandler = function() {
  var self = this;
  if(!self._processHandlerRegistered) {
    process.on('uncaughtException', function(err) {
      self._onError(err, self.dieOnError);
    });
    self._processHandlerRegistered = true;
  }
}
